    ...
    <Box sx={{ my: 8 }}>
      ...
      <Stack spacing={3}>
        ...
        <Paper sx={{ p: 4 }} variant="outlined" >
          ...
          <Typography>
            just start typing. we use cascading autocomplete to instantly link your tab to existing metadata, or seamlessly create missing entities in the background.
          </Typography>
        </Paper>
      </Stack>
    </Box>
